$.lang.register('pointsystem.add.all.success', '$1 han sido enviados a todos en el canal!');
...
$.lang.register('pointsystem.take.all.usage', 'Uso: !points takeall [amount]');
...
$.lang.register('pointsystem.add.usage', 'Uso: !points add [name] [amount]');
...
$.lang.register('pointsystem.makeitrain.usage', 'Uso: !makeitrain [amount]');
...
$.lang.register('pointsystem.set.bonus.usage', 'Uso: !points bonus [amount]');
...
$.lang.register('pointsystem.set.gain.offline.usage', 'Uso: !points setofflinegain [amount], if you have !permissionpoints set, it will override this!');
$.lang.register('pointsystem.set.gain.success', 'Set the $1 earnings to $2 every $3 minute(s) while the stream is online.');
$.lang.register('pointsystem.set.gain.usage', 'Uso: !points setgain [amount], if you have !permissionpoints set, it will override this!');
...
$.lang.register('pointsystem.set.interval.offline.usage', 'Uso: !points setofflineinterval [amount]');
$.lang.register('pointsystem.set.interval.success', 'Set the $1 payout interval to $2 minute(s) when the stream is online.');
$.lang.register('pointsystem.set.interval.usage', 'Uso: !points setinterval [amount]');
...
$.lang.register('pointsystem.set.name.usage', 'Uso: !points setname [single | multiple | delete] [name].  Sets the single or multiple name for chat points or deletes the values.');
...
$.lang.register('pointsystem.setbalance.usage', 'Uso: !points set [name] [amount]');
...
$.lang.register('pointsystem.take.usage', 'Uso: !points take [name] [amount]');
$.lang.register('pointsystem.gift.usage', 'Uso: !gift [user] [amount]');
...
$.lang.register('pointsystem.err.penalty', 'Uso: !penalty (user) (time in minutes)');
